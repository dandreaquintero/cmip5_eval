...
def pr_time_series(nc_in, param_in, region, box_in, model_in, print_info=False):
    '''
    avg_time_series ....
    ...
    nc_pmax = os.path.splitext(nc_in_filename)[0]+'_'+region+"_pmax.nc"
    nc_pmax_fldmax = os.path.splitext(nc_in_filename)[0]+'_'+region+"_pmax_fldmax.nc"

    png_pmax = os.path.splitext(nc_in_filename)[0]+'_'+region+"_pmax.png"
    png_pmax_fldmax = os.path.splitext(nc_in_filename)[0]+'_'+region+"_pmax_fldmax.png"
    ...
    title_pmax = ('Precipitation max for ' + region + ' for model ' + model_in)
